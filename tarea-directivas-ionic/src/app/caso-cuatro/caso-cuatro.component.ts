...
@Component({
  selector: 'app-caso-cuatro',
  templateUrl: './caso-cuatro.component.html',
  styleUrls: ['./caso-cuatro.component.scss', 'Reprobado.css', 'Aprobado.css'],
  standalone: true,
...
export class CasoCuatroComponent{
